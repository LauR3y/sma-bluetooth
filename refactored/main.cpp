...
int main(int argc, const char* argv[]) {
	...
	context.send(SbMessageL2(addr, login));
...
// 0x00 0x00 0x00 0x01 0x00 0x00 0x00
// Waiting for 0x0500
// Received: 0x0a00     Login2
// 0x7e 0x1f 0x00 0x61 0xca 0x19 0x21 0x25
// 0x80 0x00 0x00 0x00 0x00 0x00 0x00 0x00
// 0x0a 0x00                             Login2
// 0xca 0x19 0x21 0x25 0x80 0x00         SmaBtAddr
// 0x01                                  ??? - number of addresses following?
// 0xdf 0xbc 0xeb 0xeb 0x27 0xb8         MyBtAddr
// Waiting for 0x0500
// Received: 0x0c00    Login3
...
// Sending: 0x0300
// 0x7e 0x14 0x00 0x6a
// 0x00 0x00 0x00 0x00 0x00 0x00        from
// 0xca 0x19 0x21 0x25 0x80 0x00        to
// 0x03 0x00                            Request
// 0x05 0x00                            ??????? - get signal strength?
// Waiting for 0x0400
// Received: 0x0400
// 0x7e 0x18 0x00 0x66 0xca 0x19 0x21 0x25
// 0x80 0x00 0x00 0x00 0x00 0x00 0x00 0x00
// 0x04 0x00                            ???????
// 0x05 0x00                            ??????? - signal strength
// 0x00 0x00                            ???????
// 0xba                                 Signal Strength
// 0x00                                 ???????
// Found 0x0400
// Signal Strength: 72%
